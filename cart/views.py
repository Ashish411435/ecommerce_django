...
def add_cart(request, product_id):
    ...
    try:
        cart = Cart.objects.get(cart_id=_cart_id(request)) #get the cart using the cart_id id present in the session
    ...
    if cart_item_exists:
        ...
        if product_variation in existing_var_list:
            ...
            create_cart_item(product, cart, product_variation)
    else:
        create_cart_item(product, cart, product_variation)
    return redirect('cart')

def create_cart_item(product, cart, product_variation):
